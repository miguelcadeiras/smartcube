...
#define MOTION_SPEED_UPDATE_TIMEOUT 1000

#define MOTION_TURN_RIGHT 1
#define MOTION_TURN_LEFT -1

#define MOTION_SETSPEED_MAX 8000
#define MOTION_SETSPEED_MIN 200

#define STEPPER_STEPS_PER_TURN 800.0
#define MOTION_STEPPER_RATIO  2.85        // 57 / 20 
